...
class AuthForgotPasswordlocators:
    ...
    # восстановить пароль
    INPUT_ACTIVE = By.CSS_SELECTOR, '.input.input_status_active'  # активное поле пароль
    SHOW_PASSWORD_BUTTON = By.XPATH, '//div[contains(@class,"icon-action")]'  # Показать пароль
